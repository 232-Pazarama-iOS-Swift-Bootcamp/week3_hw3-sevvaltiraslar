//
//  EbookFavoritesViewController.swift
//  İTunes Client App
//
...
class EbookFavoritesViewController: UIViewController {
...
extension EbookFavoritesViewController: UITableViewDelegate, UITableViewDataSource {
