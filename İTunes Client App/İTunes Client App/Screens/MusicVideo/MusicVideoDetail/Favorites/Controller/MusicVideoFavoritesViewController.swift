//
//  MusicVideoFavoritesViewController.swift
//  İTunes Client App
//
...
class MusicVideoFavoritesViewController: UIViewController {
...
extension MusicVideoFavoritesViewController: UITableViewDelegate, UITableViewDataSource {
