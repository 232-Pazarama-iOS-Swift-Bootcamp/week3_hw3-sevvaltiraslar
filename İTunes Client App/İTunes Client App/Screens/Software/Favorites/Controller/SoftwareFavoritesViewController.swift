//
//  SoftwareFavoritesViewController.swift
//  İTunes Client App
//
...
class SoftwareFavoritesViewController: UIViewController {
...
extension SoftwareFavoritesViewController: UITableViewDelegate, UITableViewDataSource {
