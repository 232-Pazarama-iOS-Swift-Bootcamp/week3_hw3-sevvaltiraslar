//
//  TvShowFavoritesViewController.swift
//  İTunes Client App
//
...
class TvShowFavoritesViewController: UIViewController {
...
extension TvShowFavoritesViewController: UITableViewDelegate, UITableViewDataSource {
